//! Build and packaging tasks for the generator plugin.
...
const PLUGIN_NAME: &str = "generator-plugin";
const PLUGIN_LIB:  &str = "generator_plugin"; // hyphens → underscores
const BUNDLE_ID:   &str = "org.ccrma.generator-plugin";
