...
const PLUGIN_ID: &[u8] = b"org.ccrma.generator-plugin\0";
...
static S_MY_PLUG_DESC: clap_plugin_descriptor = clap_plugin_descriptor {
    ...
    name:         b"Generator Plugin\0".as_ptr() as *const c_char,
    ...
    description:  b"A simple signal generator plugin.\0".as_ptr() as *const c_char,
