//! Build and packaging tasks for the filter plugin.
...
const PLUGIN_NAME: &str = "filter-plugin";
const PLUGIN_LIB:  &str = "filter_plugin"; // hyphens → underscores
const BUNDLE_ID:   &str = "org.ccrma.filter-plugin";
