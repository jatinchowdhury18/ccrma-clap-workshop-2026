//! Build and packaging tasks for the dynamics plugin.
...
const PLUGIN_NAME: &str = "dynamics-plugin";
const PLUGIN_LIB:  &str = "dynamics_plugin";
const BUNDLE_ID:   &str = "org.ccrma.dynamics-plugin";
