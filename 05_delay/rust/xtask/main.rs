//! Build and packaging tasks for the delay plugin.
...
const PLUGIN_NAME: &str = "delay-plugin";
const PLUGIN_LIB:  &str = "delay_plugin";
const BUNDLE_ID:   &str = "org.ccrma.delay-plugin";
